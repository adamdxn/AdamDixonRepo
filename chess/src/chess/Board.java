...
public class Board {
	...
	private boolean testMovePiece(Coordinate initialPosition, Coordinate finalPosition) {
		boolean canMove = false;
		
		if (board[initialPosition.getX()][initialPosition.getY()] == null)
			return canMove;

		if (pieceCanMove(board[initialPosition.getX()][initialPosition.getY()], finalPosition)) {
			canMove = true;
			board[initialPosition.getX()][initialPosition.getY()].move(finalPosition);
			board[finalPosition.getX()][finalPosition.getY()] = board[initialPosition.getX()][initialPosition.getY()];
			board[initialPosition.getX()][initialPosition.getY()] = null;
		}
		return canMove;
	}
	...
	public boolean pieceCanCapture(Piece piece, Coordinate finalPosition) {
		return piece.canCapture(finalPosition) 
				&& isClear(piece, finalPosition) 
	 ...
	 */
	private LinkedList<Move> getAllMoves(Piece piece){
	...
	public LinkedList<Move> help() {
		return getAllMoves(board[0][1]);
	}
