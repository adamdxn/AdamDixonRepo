...
public class Board {
	 ...
	 * can be moved if there are no other pieces occupying the newPosition and
	 * the path for that piece is clear.
	 */
	public boolean pieceCanMove(Piece piece, Coordinate newPosition) {
		...
		// Path path = new Path(newPosition, this.board, piece);
		return false;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(board.getKing("Black").getPosition().getY());
		board.move(3, 1, 3, 2);
		board.move(3, 0, 3, 1);
